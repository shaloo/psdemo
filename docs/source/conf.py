...
master_doc = 'index'
relnotes_doc = 'relnotes'
get_started_doc = 'get-started'
dev_guide_doc = 'dev-guide'
user_guide_doc = 'user-guide'
faq_doc = 'faq'
...
man_pages = [
    (master_doc, 'psdemo', u'psdemo Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'psdemo', u'psdemo Documentation',
     author, 'psdemo', 'One line description of project.',
     'Miscellaneous'),
]
